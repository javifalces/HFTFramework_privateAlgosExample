 ...
 */
@Getter
public class ExampleAlgoGui implements AlgorithmGui {
    @Getter
    @Setter
    ...
    private Logger logger = LogManager.getLogger(ExampleAlgoGui.class);
    ...
    public ExampleAlgoGui(Instrument instrument, ChartTheme theme) {
